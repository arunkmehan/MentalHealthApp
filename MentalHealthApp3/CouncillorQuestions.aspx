<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CouncillorQuestions.aspx.cs" Inherits="MentalHealthApp3.CouncillorQuestions" %>
...
<body>
    <form id="form1" runat="server">
         <div>
            <h1><center>Councillor Questions</center></h1>
        </div>
        ...
        <br />
        <div>
            <h3><center>Please enter your anonymous question below:</center></h3>
        </div>
